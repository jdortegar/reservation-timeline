  ...
  return (
    ...
    >
      <div className="flex relative" style={{ height: '100%' }}>
        ...
        <div
          className="flex relative bg-white shrink-0"
        ...
        >
          {timeSlots.map((slot, index) => {
            ...
            return (
              <div
                key={index}
                className="border-r flex items-center justify-center text-xs font-medium text-gray-700"
                style={{
                  width: cellWidth,
                  height: '100%',
